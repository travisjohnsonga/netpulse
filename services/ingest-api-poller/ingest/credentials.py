"""
OpenBao-backed credential manager for vendor API integrations.

Credentials are fetched from OpenBao KV v2 at paths like
`secret/vendor/meraki-org1`.  Results are cached in memory with a
configurable TTL.  All OpenBao I/O runs in a thread-pool executor so it
